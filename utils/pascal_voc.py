...
class pascal_voc(object):
    ...
    def load_pascal_annotation(self,
                               index):  # Load image and bounding boxes info from XML file in the PASCAL VOC format
        ...
        for obj in objs:  # 记录出xml文件中object框的位置
            ...
            boxes = [(x2 + x1) / 2.0, (y2 + y1) / 2.0, x2 - x1,
                     y2 - y1]  # 将坐标(x1,y1,x2,y2)转变成(x_center,y_center,width,height)
